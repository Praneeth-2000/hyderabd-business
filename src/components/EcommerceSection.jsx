            ...
            <div className="shopify-showcase">
                <div className="shopify-nav">
                    ...
                    <div className="shopify-bag">
                        <img src={shopifyLogo} alt="Shopify" className="shopify-logo-img" />
                    </div>
                ...
                <div className="shopify-info">
                    <h3 className="platform-title">shopify</h3>
                    <p className="platform-subtitle">All-in-one eCommerce platform</p>
                </div>
            </div>
