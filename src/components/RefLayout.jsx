...
import servicesIcon from '../assets/Vector-4.svg';
...
const RefLayout = () => {
    ...
    useEffect(() => {
        ...
        // Also show on mount briefly or wait for scroll? 
        // Let's show on mount briefly to let user know it exists, then hide
        setIsNavVisible(true);
        scrollTimeoutRef.current = setTimeout(() => {
            setIsNavVisible(false);
        }, 3000);
        ...
        <div className="ref-layout">
            ...
            <header className="ref-header">
                ...
                <div className="header-right">
                    <div className="corner-curl">
                        <img src={cornerCurl} alt="Corner UI element" />
                    </div>
                </div>
            </header>
            ...
            <section className="hero-section">
                ...
                <p className="description">
                    Not just a digital presence—your website is your first impression.
                    From stunning designs to powerful CMS and eCommerce solutions,
                    we create digital experiences that captivate, connect, and convert.
                </p>
                ...
                {/* CTA Button */}
                <button className="audit-button">get free website audit</button>
            </section>

            {/* Floating Bottom Navigation */}
            <nav className={`bottom-nav ${isNavVisible ? 'visible' : ''}`}>
